...
let sig_stats_overall dbh =
  ...
  let overall_valid_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let level_0x10_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE level = 16 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE level = 16 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let level_0x11_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE level = 17 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE level = 17 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let level_0x12_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE level = 18 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE level = 18 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let level_0x13_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE level = 19 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE level = 19 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  ...
  let valid_expiring_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND sigs.exptime < $today) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND sigs.exptime > $today)" in
  let md5_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE sigs.hash_alg = 1 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE sigs.hash_alg = 1 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let sha1_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE sigs.hash_alg = 2 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE sigs.hash_alg = 2 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let ripemd160_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE sigs.hash_alg = 3 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE sigs.hash_alg = 3 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let sha256_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE sigs.hash_alg = 8 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE sigs.hash_alg = 8 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let sha384_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE sigs.hash_alg = 9 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE sigs.hash_alg = 9 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let sha512_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE sigs.hash_alg = 10 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE sigs.hash_alg = 10 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
  let sha224_sigs = PGSQL(dbh) "(SELECT COUNT(*) FROM sigs INNER JOIN keys ON sigs.signer = keys.keyid WHERE sigs.hash_alg = 11 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today)) INTERSECT (SELECT COUNT(*) FROM sigs INNER JOIN KEYS ON sigs.signee = keys.keyid WHERE sigs.hash_alg = 11 AND keys.revoktime IS NULL AND (keys.exptime IS NULL OR keys.exptime > $today) AND sigs.revoktime IS NULL AND (sigs.exptime IS NULL OR sigs.exptime > $today))" in
    printf "total number of sigs %Ld\n" (extract_first overall_sigs);
    printf "total number of revoked sigs %Ld" (extract_first revoked_sigs);
    printf "total number of valid sigs with expire dates %Ld" (extract_first valid_expiring_sigs);
    printf "total number of valid sigs %Ld (valid sigs = not expired and not revoked and signer and signee are valid)\n" (extract_first overall_valid_sigs);
    printf "total number of valid sigs with cert level 0x10 (generic) %Ld\n" (extract_first level_0x10_sigs);
    printf "total number of valid sigs with cert level 0x11 (persona) %Ld\n" (extract_first level_0x11_sigs);
    printf "total number of valid sigs with cert level 0x12 (casual) %Ld\n" (extract_first level_0x12_sigs);
    printf "total number of valid sigs with cert level 0x13 (positive) %Ld\n" (extract_first level_0x13_sigs);
    printf "total number of valid sigs with hash algorithm MD5 (be cautious) %Ld\n" (extract_first md5_sigs);
    printf "total number of valid sigs with hash algorithm SHA1 (be cautious) %Ld\n" (extract_first sha1_sigs);
    printf "total number of valid sigs with hash algorithm RIPE-MD/160 (be cautious) %Ld\n" (extract_first ripemd160_sigs);
    printf "total number of valid sigs with hash algorithm SHA256 (be cautious) %Ld\n" (extract_first sha256_sigs);
    printf "total number of valid sigs with hash algorithm SHA256 (be cautious) %Ld\n" (extract_first sha384_sigs);
