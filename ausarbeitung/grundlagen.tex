...
Milgram bahnbrechendes Experiment... (kurze Beschreibung, Zitat)
Dieses Verhalten wird als Small-World-Effekt bezeichnet. Tritt in
vielen Netzwerken auf, insbesondere in sozialen Netzwerken (Zitat).

Strogan/Watts: Klasse von Netzwerken mit geringer durchschnittlicher
Distanz und viel Clustering. Modell, um solche Netzwerke zu erzeugen
(Zitat).
