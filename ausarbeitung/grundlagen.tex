...
Die Zeitkomplexit\"at von COPRA wird mit $\mathcal{O}(v^3n)$
...
Netzwerkeigenschaften (Gr\"osse des Netzwerkes, Distanzen,
Gradverteilung etc.) und verfolgten deren Entwicklung \emph{\"uber die
  Zeit}. Ihre Ergebnisse k\"onnen allerdings mit den in dieser Arbeit
pr\"asentierten nicht verglichen werden, da der Graph von Schl\"usseln
