...
m\"ussen. Da der Algorithmus von Blondel et al. genauso wie Fastmod
mittels einer (lokalen) Optimierung der Modularity arbeitet, k\"onnte
dieses Ph\"anomen auf das in der Literatur beschriebene
Aufl\"osungslimit der Modularity-Funktion (bspw. \cite{Good2009}) zur\"uckzuf\"uhren sein.
...
\ref{sec:community-analyse} dargelegt, wird davon ausgegangen, dass ein
...
Bekannten, Gesch\"aftspartner und sonstigen Kontakte wieder Finnen sind.
