...
\subsection{Verteilung der Grade, Skalenfreiheit}
...
signifikaten Anzahl von Knoten mit hohem Grad. Eine zentrale Rolle bei
den Eigenschaften, die skalenfreien Netzwerken zugeschrieben werden,
spielt die Existenz eines Kerns bestehend aus ``Hubs'', also Knoten mit
hohem Grad, die untereinander verbunden sind. Knoten mit niedrigem
Grad sind prim\"ar mit diesen Hubs verbunden. Dieser Kern h\"alt das
Netzwerk zusammen und sorgt f\"ur geringe Distanzen. Allerdings haben
Li et al. \cite{Li2005} gezeigt, dass die Existenz einer
Power-Law-Verteilung nicht ausreicht, um die Existenz von Hubs
nachzuweisen. Es existieren Netzwerke, die zwar eine
...
der Assortativity-Koeffizient $r$ (siehe Abschnitt
\ref{ch:Grundlagen:sec:Netzwerkanalyse:subsec:Statistiken})
berechnet. Es ergibt sich ein Wert $r = 0,113$. Aus diesem positiven
Wert folgt ebenfalls, dass Knoten tendenziell mit Knoten verbunden
...
erh\"ohen. Da Standardorganisationen eine Abkehr von RSA-1024
empfehlen [cite NIST] und praktikable Angriffe wohl nur eine Frage
