...
\emph{Robustheit} des Netzwerkes. Einf\"uhrung mit Verweis auf
Scale-Free. [zuf\"allige Knoten kein Problem, high-deg schon].
...
Sch\"adigung. Ein Angreifer mit der Intention, das Netz an sich zu
sch\"adigen, wird solche Knoten ausw\"ahlen, deren Entfernung einen
...
Komponent erheblich. Die M\"glichkeiten eines Angreifers d\"urften
...
Netzwerkes (siehe Abschnitt \ref{sec:nutzlichkeit}). Aufgrund des
notwendigen Rechenaufwandes konnte dies im Rahmen dieser Arbeit aber
nicht durchgef\"uhrt werden.
...
tauchen CA-Schl\"ussel nur auf relativ wenigen k\"urzesten Pfaden
auf. Ihre Entfernung richtet also -- zumindest in Bezug auf die
Distanzen -- einen relativ geringen Schaden an.
...
Es ist zu erwarten, dass sich der Anteil von RSA-Schl\"usseln mit
