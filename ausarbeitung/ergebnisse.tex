...
\begin{figure}[th!]
  \centering
  \includegraphics[scale=0.7]{images/neighbourhood-cdf.pdf}
...
\begin{figure}[th!]
  \centering
  \includegraphics[scale=0.4]{images/pathlen-dist.pdf}
  \caption{Verteilung der durschnittlichen Pfadl\"angen der gr\"ossten starken Zusammenhangskomponente}
  \label{fig:pathlen-dist}
\end{figure}

\begin{figure}[th!]
  \centering
  \includegraphics[scale=0.4]{images/ecc-dist.pdf}
  \caption{Verteilung der Eccentricity in der gr\"ossten starken Zusammenhangskomponente}
  \label{fig:ecc-dist}
\end{figure}
