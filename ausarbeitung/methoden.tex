...
\emph{wotsap}-Projekt stellt einen t\"aglich aktualisierten Datensatz
zur Verf\"ugung, der die Struktur des Web of Trust beinhaltet. In
...
des signierenden Schl\"ussels. Diese Reduktion erlaubt zwar eine sehr
...
Teilen: Der in SKS integrierte Extraktionsteil liesst Schlüssel aus
...
auf dem Keyserver vorgenommen werden, während die Daten anschliessend
...
\section{Schl\"ussel und Invididuen}
...
\subsection{\"Uberlappende Communities im ungerichteten Graphen}
