...
copra1 <- scan(paste(ldir, "TLD_MAYBE_ASS_sizes.dat", sep=""))
copra <- scan(paste(cdir, "TLD_MAYBE_ASS_sizes.dat", sep=""))
bl2 <- scan(paste(bl2dir, "TLD_MAYBE_ASS_sizes.dat", sep=""))
bl5 <- scan(paste(bl5dir, "TLD_MAYBE_ASS_sizes.dat", sep=""))
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/tld-maybe-ass_copra.pdf", type="pdf")
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/tld-maybe-ass_copra1.pdf", type="pdf")
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/tld-maybe-ass_bl2.pdf", type="pdf")
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/tld-maybe-ass_bl5.pdf", type="pdf")
