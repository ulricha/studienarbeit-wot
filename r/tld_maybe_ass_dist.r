...
fastmod <- scan(paste(fdir, "TLD_MAYBE_sizes.dat", sep=""))
label <- scan(paste(ldir, "TLD_MAYBE_sizes.dat", sep=""))
copra <- scan(paste(cdir, "TLD_MAYBE_sizes.dat", sep=""))
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/tld_maybe_dist.pdf", type="pdf") 
