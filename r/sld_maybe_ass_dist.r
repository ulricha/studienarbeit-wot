...
fastmod <- scan(paste(fdir, "SLD_MAYBE_sizes.dat", sep=""))
label <- scan(paste(ldir, "SLD_MAYBE_sizes.dat", sep=""))
copra <- scan(paste(cdir, "SLD_MAYBE_sizes.dat", sep=""))
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/sld_maybe_dist.pdf", type="pdf") 