...
fastmod <- scan(paste(fdir, "TLD_SURE_sizes.dat", sep=""))
label <- scan(paste(ldir, "TLD_SURE_sizes.dat", sep=""))
copra <- scan(paste(cdir, "TLD_SURE_sizes.dat", sep=""))
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/tld_sure_dist.pdf", type="pdf")