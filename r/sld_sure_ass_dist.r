...
copra1 <- scan(paste(ldir, "SLD_SURE_ASS_sizes.dat", sep=""))
copra <- scan(paste(cdir, "SLD_SURE_ASS_sizes.dat", sep=""))
bl2 <- scan(paste(bl2dir, "SLD_SURE_ASS_sizes.dat", sep=""))
bl5 <- scan(paste(bl5dir, "SLD_SURE_ASS_sizes.dat", sep=""))
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/sld-sure-ass_copra.pdf", type="pdf")
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/sld-sure-ass_copra1.pdf", type="pdf")
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/sld-sure-ass_bl2.pdf", type="pdf")
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/sld-sure-ass_bl5.pdf", type="pdf")
