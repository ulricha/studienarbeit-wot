...
fastmod <- scan(paste(fdir, "SLD_SURE_sizes.dat", sep=""))
label <- scan(paste(ldir, "SLD_SURE_sizes.dat", sep=""))
copra <- scan(paste(cdir, "SLD_SURE_sizes.dat", sep=""))
...
quartz.save("dev/studienarbeit-wot/ausarbeitung/images/sld_sure_dist.pdf", type="pdf") 